...
public class ArchivedCategoriesIncomeFragment extends Fragment {

    @BindView(R.id.fragment_archived_category_income_rv)
    RecyclerView recyclerView;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_archived_categories_income, container, false);
        ButterKnife.bind(this, v);

        final DatabaseHandler databaseHandler = new DatabaseHandler(getContext());
        final OrderedRealmCollection<Category> categoriesIncome = databaseHandler.getArchivedCategoriesIncome();
